...
class Player{
	...
	constructor(nc, id){
		...
		setTimeout(() => {
			this.interval = setInterval(() => this.tick(), nc.config.csTime ? nc.config.csTime : this.tickTime)
		}, 100)
	...
	clientSnap(){
		...
		p.unitID = this.unit.unit ? this.unit.unit[1] : undefined
